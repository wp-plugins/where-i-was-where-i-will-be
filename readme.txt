...
* Fixed conflict when there is a single quote (‘) on text
...
= 1.0.5 =
* Add option to cluster markers (Using: https://github.com/googlemaps/js-marker-clusterer)
* Adjust minor issue when loading map
* Removed not used javascript files 

= 1.0.4 =
* Adjust loading info from Google Maps (Admin page)


= 1.0.3 =
* Adjust error when loading Flag (Admin page)
* Adjust var when transfer info from Map to Form (Admin page)

= 1.0.2 =
* Adjust error at loading map on user side
